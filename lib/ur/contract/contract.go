...
type Report struct {
	...
	FolderUsesV3 struct {
		...
		PullOrder               map[string]int `json:"pullOrder,omitempty"               metric:""                                         since:"3"`
		FilesystemType          map[string]int `json:"filesystemType,omitempty"          metric:""                                         since:"3"`
		...
		BlockPullOrder          map[string]int `json:"blockPullOrder,omitempty"          metric:""                                         since:"3"`
		CopyRangeMethod         map[string]int `json:"copyRangeMethod,omitempty"         metric:""                                         since:"3"`
	...
	GUIStats struct {
		...
		Theme                     map[string]int `json:"theme,omitempty"                     metric:""                                       since:"3"`
