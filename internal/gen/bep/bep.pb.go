...
const file_bep_bep_proto_rawDesc = "" +
	"\n" +
	"\rbep/bep.proto\x12\x03bep\"\xb7\x01\n" +
	"\x05Hello\x12\x1f\n" +
	...
	"\tsecondary\x18\x02 \x01(\bR\tsecondary\"\x90\x02\n" +
	"\x06Folder\x12\x0e\n" +
	...
	"\x0eno_permissions\x18\b \x01(\bR\rnoPermissions\"Q\n" +
	"\tBlockInfo\x12\x12\n" +
	"\x04hash\x18\x03 \x01(\fR\x04hash\x12\x16\n" +
	"\x06offset\x18\x01 \x01(\x03R\x06offset\x12\x12\n" +
	"\x04size\x18\x02 \x01(\x05R\x04sizeJ\x04\b\x04\x10\x05\"2\n" +
	"\x06Vector\x12(\n" +
	...
	"\x0efrom_temporary\x18\a \x01(\bR\rfromTemporary\x12\x19\n" +
	"\bblock_no\x18\t \x01(\x05R\ablockNoJ\x04\b\b\x10\t\"R\n" +
	"\bResponse\x12\x0e\n" +
	...
	")FILE_DOWNLOAD_PROGRESS_UPDATE_TYPE_FORGET\x10\x01Bp\n" +
	"\acom.bepB\bBepProtoP\x01Z/github.com/syncthing/syncthing/internal/gen/bep\xa2\x02\x03BXX\xaa\x02\x03Bep\xca\x02\x03Bep\xe2\x02\x0fBep\\GPBMetadata\xea\x02\x03Bepb\x06proto3"

var (
	file_bep_bep_proto_rawDescOnce sync.Once
	file_bep_bep_proto_rawDescData []byte
)

func file_bep_bep_proto_rawDescGZIP() []byte {
	file_bep_bep_proto_rawDescOnce.Do(func() {
		file_bep_bep_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_bep_bep_proto_rawDesc), len(file_bep_bep_proto_rawDesc)))
	})
...
func file_bep_bep_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_bep_bep_proto_rawDesc), len(file_bep_bep_proto_rawDesc)),
			NumEnums:      6,
			NumMessages:   22,
			NumExtensions: 0,
			NumServices:   0,
