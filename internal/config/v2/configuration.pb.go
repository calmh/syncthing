...
var file_config_v2_configuration_proto_goTypes = []any{
	...
	(*FolderConfiguration)(nil),  // 1: syncthing.config.v2.FolderConfiguration
	(*DeviceConfiguration)(nil),  // 2: syncthing.config.v2.DeviceConfiguration
	(*OptionsConfiguration)(nil), // 3: syncthing.config.v2.OptionsConfiguration
}
var file_config_v2_configuration_proto_depIdxs = []int32{
	1, // 0: syncthing.config.v2.Configuration.folders:type_name -> syncthing.config.v2.FolderConfiguration
	2, // 1: syncthing.config.v2.Configuration.devices:type_name -> syncthing.config.v2.DeviceConfiguration
	3, // 2: syncthing.config.v2.Configuration.options:type_name -> syncthing.config.v2.OptionsConfiguration
...
func file_config_v2_configuration_proto_init() {
	...
	file_config_v2_device_configuration_proto_init()
