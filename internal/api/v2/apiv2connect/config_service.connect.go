...
const (
	...
	ConfigurationServiceName = "syncthing.api.v2.ConfigurationService"
)
...
const (
	...
	ConfigurationServiceGetConfigurationProcedure = "/syncthing.api.v2.ConfigurationService/GetConfiguration"
	...
	ConfigurationServiceWatchConfigurationProcedure = "/syncthing.api.v2.ConfigurationService/WatchConfiguration"
	// ConfigurationServiceUpdateOptionsProcedure is the fully-qualified name of the
	// ConfigurationService's UpdateOptions RPC.
	ConfigurationServiceUpdateOptionsProcedure = "/syncthing.api.v2.ConfigurationService/UpdateOptions"
	// ConfigurationServiceAddDeviceProcedure is the fully-qualified name of the ConfigurationService's
	// AddDevice RPC.
	ConfigurationServiceAddDeviceProcedure = "/syncthing.api.v2.ConfigurationService/AddDevice"
	// ConfigurationServiceRemoveDeviceProcedure is the fully-qualified name of the
	// ConfigurationService's RemoveDevice RPC.
	ConfigurationServiceRemoveDeviceProcedure = "/syncthing.api.v2.ConfigurationService/RemoveDevice"
	// ConfigurationServiceUpdateDeviceProcedure is the fully-qualified name of the
	// ConfigurationService's UpdateDevice RPC.
	ConfigurationServiceUpdateDeviceProcedure = "/syncthing.api.v2.ConfigurationService/UpdateDevice"
	// ConfigurationServiceAddFolderProcedure is the fully-qualified name of the ConfigurationService's
	// AddFolder RPC.
	ConfigurationServiceAddFolderProcedure = "/syncthing.api.v2.ConfigurationService/AddFolder"
	// ConfigurationServiceRemoveFolderProcedure is the fully-qualified name of the
	// ConfigurationService's RemoveFolder RPC.
	ConfigurationServiceRemoveFolderProcedure = "/syncthing.api.v2.ConfigurationService/RemoveFolder"
	// ConfigurationServiceUpdateFolderProcedure is the fully-qualified name of the
	// ConfigurationService's UpdateFolder RPC.
	ConfigurationServiceUpdateFolderProcedure = "/syncthing.api.v2.ConfigurationService/UpdateFolder"
)

// ConfigurationServiceClient is a client for the syncthing.api.v2.ConfigurationService service.
...
// NewConfigurationServiceClient constructs a client for the syncthing.api.v2.ConfigurationService
...
// GetConfiguration calls syncthing.api.v2.ConfigurationService.GetConfiguration.
...
// WatchConfiguration calls syncthing.api.v2.ConfigurationService.WatchConfiguration.
...
// UpdateOptions calls syncthing.api.v2.ConfigurationService.UpdateOptions.
...
// AddDevice calls syncthing.api.v2.ConfigurationService.AddDevice.
...
// RemoveDevice calls syncthing.api.v2.ConfigurationService.RemoveDevice.
...
// UpdateDevice calls syncthing.api.v2.ConfigurationService.UpdateDevice.
...
// AddFolder calls syncthing.api.v2.ConfigurationService.AddFolder.
...
// RemoveFolder calls syncthing.api.v2.ConfigurationService.RemoveFolder.
...
// UpdateFolder calls syncthing.api.v2.ConfigurationService.UpdateFolder.
...
// ConfigurationServiceHandler is an implementation of the syncthing.api.v2.ConfigurationService
// service.
...
func NewConfigurationServiceHandler(svc ConfigurationServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/syncthing.api.v2.ConfigurationService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedConfigurationServiceHandler) GetConfiguration(context.Context, *connect.Request[v2.GetConfigurationRequest]) (*connect.Response[v2.GetConfigurationResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("syncthing.api.v2.ConfigurationService.GetConfiguration is not implemented"))
}
...
func (UnimplementedConfigurationServiceHandler) WatchConfiguration(context.Context, *connect.Request[v2.WatchConfigurationRequest], *connect.ServerStream[v2.GetConfigurationResponse]) error {
	return connect.NewError(connect.CodeUnimplemented, errors.New("syncthing.api.v2.ConfigurationService.WatchConfiguration is not implemented"))
}
...
func (UnimplementedConfigurationServiceHandler) UpdateOptions(context.Context, *connect.Request[v2.UpdateOptionsRequest]) (*connect.Response[v2.UpdateOptionsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("syncthing.api.v2.ConfigurationService.UpdateOptions is not implemented"))
}
...
func (UnimplementedConfigurationServiceHandler) AddDevice(context.Context, *connect.Request[v2.AddDeviceRequest]) (*connect.Response[v2.AddDeviceResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("syncthing.api.v2.ConfigurationService.AddDevice is not implemented"))
}
...
func (UnimplementedConfigurationServiceHandler) RemoveDevice(context.Context, *connect.Request[v2.RemoveDeviceRequest]) (*connect.Response[v2.RemoveDeviceResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("syncthing.api.v2.ConfigurationService.RemoveDevice is not implemented"))
}
...
func (UnimplementedConfigurationServiceHandler) UpdateDevice(context.Context, *connect.Request[v2.UpdateDeviceRequest]) (*connect.Response[v2.UpdateDeviceResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("syncthing.api.v2.ConfigurationService.UpdateDevice is not implemented"))
}
...
func (UnimplementedConfigurationServiceHandler) AddFolder(context.Context, *connect.Request[v2.AddFolderRequest]) (*connect.Response[v2.AddFolderResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("syncthing.api.v2.ConfigurationService.AddFolder is not implemented"))
}
...
func (UnimplementedConfigurationServiceHandler) RemoveFolder(context.Context, *connect.Request[v2.RemoveFolderRequest]) (*connect.Response[v2.RemoveFolderResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("syncthing.api.v2.ConfigurationService.RemoveFolder is not implemented"))
}
...
func (UnimplementedConfigurationServiceHandler) UpdateFolder(context.Context, *connect.Request[v2.UpdateFolderRequest]) (*connect.Response[v2.UpdateFolderResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("syncthing.api.v2.ConfigurationService.UpdateFolder is not implemented"))
}
